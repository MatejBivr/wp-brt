...
const appRoutes: Routes = [
  ...
  { path: 'single', component: DonateComponent, data : {type : 'SINGLE DONATION'}},
  { path: 'monthly', component: DonateComponent, data : {type : 'GIVE MONTHLY'}},
  { path: 'business', component: DonateComponent, data : {type : 'BUSINESS MEMBERSHIP'}},
